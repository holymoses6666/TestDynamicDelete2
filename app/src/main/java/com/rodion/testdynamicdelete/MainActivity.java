package com.rodion.testdynamicdelete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Button deleteField = (Button) view.findViewById(R.id.delete_btn);
                Button colapseBtn = (Button) view.findViewById(R.id.collapse_btn);
                EditText  timerTextedit = (EditText) view.findViewById(R.id.timer_textedit);
                Button restartBtn = (Button) view.findViewById(R.id.restart_btn);
